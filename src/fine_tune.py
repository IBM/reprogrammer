...
parser = argparse.ArgumentParser(description='PyTorch CLIP Fine Tuning')
...
parser.add_argument('--lr', '--learning-rate', default=0.00003, type=float, help='initial learning rate (default: 0.00003)')
...
from utils import ImageNet, PCAM, step_lr, cosine_lr
...
def main():
    ...
    optimizer = torch.optim.AdamW(params, lr=args.lr, weight_decay=args.weight_decay, betas=(0.9, 0.98), eps=1e-6)
